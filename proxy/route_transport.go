...
func NewRouteTransport(route models.ProxyRoute) http.RoundTripper {
	return NewRouteTransportWithHttpTransport(route, NewDefaultTransport())
}
func NewRouteTransportWithHttpTransport(route models.ProxyRoute, httpTransport *http.Transport) http.RoundTripper {
...
func (r *RouteTransport) InitHttpTransport() {
	...
	r.httpTransport.TLSClientConfig = &tls.Config{InsecureSkipVerify: r.route.InsecureSkipVerify}
}
